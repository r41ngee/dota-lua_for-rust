...
impl BaseNpc {
    ...
    pub fn AddSpeechBubble(&self, i_bubble: f64, psz_speech: String, fl_duration: f64, un_offset_x: f64, un_offset_y: f64) { unimplemented!() }
    ...
    pub fn CastAbilityImmediately(&self, h_ability: super::ability::CBaseAbility, i_player_index: f64) { unimplemented!() }
    pub fn CastAbilityNoTarget(&self, h_ability: super::ability::CBaseAbility, i_player_index: f64) { unimplemented!() }
    pub fn CastAbilityOnPosition(&self, v_position: Vector, h_ability: super::ability::CBaseAbility, i_player_index: f64) { unimplemented!() }
    pub fn CastAbilityOnTarget(&self, h_target: BaseNpc, h_ability: super::ability::CBaseAbility, i_player_index: f64) { unimplemented!() }
    pub fn CastAbilityToggle(&self, h_ability: super::ability::CBaseAbility, i_player_index: f64) { unimplemented!() }
    ...
    pub fn FadeGesture(&self, n_activity: f64) { unimplemented!() }
    ...
    pub fn ForcePlayActivityOnce(&self, n_activity: f64) { unimplemented!() }
    pub fn GetAbilityByIndex(&self, ability_index: f64) -> super::ability::CBaseAbility { unimplemented!() }
    pub fn GetAbilityCount(&self) -> f64 { unimplemented!() }
    pub fn GetAcquisitionRange(&self) -> f64 { unimplemented!() }
    pub fn GetAdditionalBattleMusicWeight(&self) -> f64 { unimplemented!() }
    pub fn GetAggroTarget(&self) -> BaseNpc { unimplemented!() }
    pub fn GetAttackAnimationPoint(&self) -> f64 { unimplemented!() }
    pub fn GetAttackCapability(&self) -> f64 { unimplemented!() }
    pub fn GetAttackDamage(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetAverageTrueAttackDamage(&self, h_target: BaseNpc) -> f64 { unimplemented!() }
    pub fn GetBaseAttackTime(&self) -> f64 { unimplemented!() }
    pub fn GetBaseDamageMax(&self) -> f64 { unimplemented!() }
    pub fn GetBaseDamageMin(&self) -> f64 { unimplemented!() }
    pub fn GetBaseDayTimeVisionRange(&self) -> f64 { unimplemented!() }
    pub fn GetBaseHealthRegen(&self) -> f64 { unimplemented!() }
    pub fn GetBaseMagicalResistanceValue(&self) -> f64 { unimplemented!() }
    pub fn GetBaseMaxHealth(&self) -> f64 { unimplemented!() }
    pub fn GetBaseMoveSpeed(&self) -> f64 { unimplemented!() }
    pub fn GetBaseNightTimeVisionRange(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetCurrentVisionRange(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetDayTimeVisionRange(&self) -> f64 { unimplemented!() }
    pub fn GetDeathXP(&self) -> f64 { unimplemented!() }
    pub fn GetForceAttackTarget(&self) -> BaseNpc { unimplemented!() }
    pub fn GetGoldBounty(&self) -> f64 { unimplemented!() }
    pub fn GetHasteFactor(&self) -> f64 { unimplemented!() }
    pub fn GetHealthDeficit(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetItemInSlot(&self, slot: f64) -> super::item::CDOTA_Item { unimplemented!() }
    ...
    pub fn GetMainControllingPlayer(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetMaximumGoldBounty(&self) -> f64 { unimplemented!() }
    pub fn GetMinimumGoldBounty(&self) -> f64 { unimplemented!() }
    pub fn GetModelRadius(&self) -> f64 { unimplemented!() }
    pub fn GetModifierCount(&self) -> f64 { unimplemented!() }
    pub fn GetModifierNameByIndex(&self, n_index: f64) -> String { unimplemented!() }
    pub fn GetModifierStackCount(&self, modifier_name: String, h_caster: BaseNpc) -> f64 { unimplemented!() }
    ...
    pub fn GetNightTimeVisionRange(&self) -> f64 { unimplemented!() }
    pub fn GetOpposingTeamNumber(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetPlayerOwnerID(&self) -> f64 { unimplemented!() }
    pub fn GetProjectileSpeed(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetTotalPurchasedUpgradeGoldCost(&self) -> f64 { unimplemented!() }
    ...
    pub fn IsOpposingTeam(&self, n_team: f64) -> bool { unimplemented!() }
    ...
    pub fn MakeVisibleDueToAttack(&self, i_team: f64) { unimplemented!() }
    pub fn MakeVisibleToTeam(&self, i_team: f64, fl_duration: f64) { unimplemented!() }
    pub fn ManageModelChanges(&self) { unimplemented!() }
    pub fn ModifyHealth(&self, i_desired_health_value: f64, h_ability: super::ability::CBaseAbility, b_lethal: bool, i_additional_flags: f64) { unimplemented!() }
    ...
    pub fn RemoveGesture(&self, n_activity: f64) { unimplemented!() }
    ...
    pub fn SetAbilityByIndex(&self, h_ability: super::ability::CBaseAbility, i_index: f64) { unimplemented!() }
    pub fn SetAcquisitionRange(&self, n_range: f64) { unimplemented!() }
    ...
    pub fn SetAttackCapability(&self, i_attack_capabilities: f64) { unimplemented!() }
    ...
    pub fn SetBaseDamageMax(&self, n_max: f64) { unimplemented!() }
    pub fn SetBaseDamageMin(&self, n_min: f64) { unimplemented!() }
    ...
    pub fn SetBaseMoveSpeed(&self, i_move_speed: f64) { unimplemented!() }
    pub fn SetCanSellItems(&self, b_can_sell: bool) { unimplemented!() }
    pub fn SetControllableByPlayer(&self, i_index: f64, b_skip_adjusting_position: bool) { unimplemented!() }
    ...
    pub fn SetCustomHealthLabel(&self, p_label: String, r: f64, g: f64, b: f64) { unimplemented!() }
    pub fn SetDayTimeVisionRange(&self, i_range: f64) { unimplemented!() }
    pub fn SetDeathXP(&self, i_xp_bounty: f64) { unimplemented!() }
    ...
    pub fn SetMaximumGoldBounty(&self, i_gold_bounty_max: f64) { unimplemented!() }
    pub fn SetMinimumGoldBounty(&self, i_gold_bounty_min: f64) { unimplemented!() }
    pub fn SetModifierStackCount(&self, psz_script_name: String, h_caster: BaseNpc, n_stack_count: f64) { unimplemented!() }
    pub fn SetMoveCapability(&self, i_move_capabilities: f64) { unimplemented!() }
    ...
    pub fn SetNightTimeVisionRange(&self, i_range: f64) { unimplemented!() }
    ...
    pub fn SetRevealRadius(&self, reveal_radius: f64) { unimplemented!() }
    ...
    pub fn StartGesture(&self, n_activity: f64) { unimplemented!() }
    pub fn StartGestureWithPlaybackRate(&self, n_activity: f64, fl_rate: f64) { unimplemented!() }
    ...
    pub fn SwapItems(&self, n_slot1: f64, n_slot2: f64) { unimplemented!() }
...
impl BaseNpcBuilding {
    pub fn GetInvulnCount(&self) -> f64 { unimplemented!() }
    pub fn SetInvulnCount(&self, n_invuln_count: f64) { unimplemented!() }
}
...
impl BaseNpcCreature {
    ...
    pub fn CreatureLevelUp(&self, i_levels: f64) { unimplemented!() }
    ...
    pub fn SetBountyGain(&self, n_bounty_gain: f64) { unimplemented!() }
    pub fn SetChampion(&self, b_is_champion: bool) { unimplemented!() }
    pub fn SetDamageGain(&self, n_damage_gain: f64) { unimplemented!() }
    pub fn SetDisableResistanceGain(&self, fl_disable_resistance_gain: f64) { unimplemented!() }
    pub fn SetHPGain(&self, n_hp_gain: f64) { unimplemented!() }
    ...
    pub fn SetManaGain(&self, n_mana_gain: f64) { unimplemented!() }
    pub fn SetManaRegenGain(&self, fl_mana_regen_gain: f64) { unimplemented!() }
    pub fn SetMoveSpeedGain(&self, n_move_speed_gain: f64) { unimplemented!() }
    pub fn SetXPGain(&self, n_xp_gain: f64) { unimplemented!() }
}
...
impl BaseNpcHero {
    pub fn AddExperience(&self, fl_xp: f64, n_reason: f64, b_apply_bot_difficulty_scaling: bool, b_increment_total: bool) -> bool { unimplemented!() }
    ...
    pub fn GetAbilityPoints(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetAssists(&self) -> f64 { unimplemented!() }
    pub fn GetAttacker(&self, n_index: f64) -> f64 { unimplemented!() }
    ...
    pub fn GetBonusDamageFromPrimaryStat(&self) -> f64 { unimplemented!() }
    pub fn GetBuybackCooldownTime(&self) -> f64 { unimplemented!() }
    pub fn GetBuybackCost(&self) -> f64 { unimplemented!() }
    pub fn GetBuybackGoldLimitTime(&self) -> f64 { unimplemented!() }
    pub fn GetCurrentXP(&self) -> f64 { unimplemented!() }
    pub fn GetDeathGoldCost(&self) -> f64 { unimplemented!() }
    pub fn GetDeaths(&self) -> f64 { unimplemented!() }
    pub fn GetDenies(&self) -> f64 { unimplemented!() }
    pub fn GetGold(&self) -> f64 { unimplemented!() }
    pub fn GetGoldBounty(&self) -> f64 { unimplemented!() }
    pub fn GetIntellect(&self) -> f64 { unimplemented!() }
    pub fn GetIntellectGain(&self) -> f64 { unimplemented!() }
    pub fn GetKills(&self) -> f64 { unimplemented!() }
    pub fn GetLastHits(&self) -> f64 { unimplemented!() }
    pub fn GetManaRegenMultiplier(&self) -> f64 { unimplemented!() }
    pub fn GetMostRecentDamageTime(&self) -> f64 { unimplemented!() }
    pub fn GetMultipleKillCount(&self) -> f64 { unimplemented!() }
    pub fn GetNumAttackers(&self) -> f64 { unimplemented!() }
    pub fn GetNumItemsInInventory(&self) -> f64 { unimplemented!() }
    pub fn GetNumItemsInStash(&self) -> f64 { unimplemented!() }
    pub fn GetPhysicalArmorBaseValue(&self) -> f64 { unimplemented!() }
    pub fn GetPlayerID(&self) -> f64 { unimplemented!() }
    pub fn GetPrimaryAttribute(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetStreak(&self) -> f64 { unimplemented!() }
    ...
    pub fn GetTogglableWearable(&self, n_slot_type: f64) -> CBaseEntity { unimplemented!() }
    pub fn HasAnyAvailableInventorySpace(&self) -> bool { unimplemented!() }
    pub fn HasFlyingVision(&self) -> bool { unimplemented!() }
    pub fn HasOwnerAbandoned(&self) -> bool { unimplemented!() }
    pub fn HasRoomForItem(&self, p_item_name: String, b_include_stash_combines: bool, b_allow_selling: bool) -> f64 { unimplemented!() }
    pub fn HeroLevelUp(&self, b_play_effects: bool) { unimplemented!() }
    pub fn IncrementAssists(&self, i_killer_id: f64) { unimplemented!() }
    pub fn IncrementDeaths(&self, i_killer_id: f64) { unimplemented!() }
    pub fn IncrementDenies(&self) { unimplemented!() }
    pub fn IncrementKills(&self, i_victim_id: f64) { unimplemented!() }
    ...
    pub fn ModifyGold(&self, i_gold_change: f64, b_reliable: bool, i_reason: f64) -> f64 { unimplemented!() }
    ...
    pub fn SetAbilityPoints(&self, i_points: f64) { unimplemented!() }
    ...
    pub fn SetBotDifficulty(&self, n_difficulty: f64) { unimplemented!() }
    ...
    pub fn SetCustomDeathXP(&self, i_value: f64) { unimplemented!() }
    pub fn SetGold(&self, i_gold: f64, b_reliable: bool) { unimplemented!() }
    pub fn SetPlayerID(&self, i_player_id: f64) { unimplemented!() }
    pub fn SetPrimaryAttribute(&self, n_primary_attribute: f64) { unimplemented!() }
    ...
    pub fn SpendGold(&self, i_cost: f64, i_reason: f64) { unimplemented!() }
    pub fn UnitCanRespawn(&self) -> bool { unimplemented!() }
...
impl CDOTAPlayer {
    ...
    pub fn SetMusicStatus(&self, n_music_status: f64, fl_intensity: f64) { unimplemented!() }
}
...
impl CDOTAMapTree {
    pub fn CutDown(&self, n_tree_number_known_to: f64) { unimplemented!() }
    pub fn CutDownRegrowAfter(&self, fl_regrow_after: f64, n_tree_number_known_to: f64) { unimplemented!() }
...
impl CDotaQuest {
    ...
    pub fn GetSubquest(&self, n_index: f64) -> CDotaSubquestBase { unimplemented!() }
    ...
    pub fn SetTextReplaceValue(&self, value_slot: f64, value: f64) { unimplemented!() }
}
